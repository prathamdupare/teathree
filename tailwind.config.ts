  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        medium: ['PlusJakartaSans-Medium', 'system-ui'],
        semibold: ['PlusJakartaSans-SemiBold', 'system-ui'],
        bold: ['PlusJakartaSans-Bold', 'system-ui'],
        italic: ['PlusJakartaSans-Italic', 'system-ui'],
