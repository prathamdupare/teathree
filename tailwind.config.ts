  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        medium: ['Ubuntu-Medium', 'system-ui'],
        semibold: ['Ubuntu-Bold', 'system-ui'],
        bold: ['Ubuntu-Bold', 'system-ui'],
        italic: ['Ubuntu-Italic', 'system-ui'],
        light: ['Ubuntu-Light', 'system-ui'],
        'medium-italic': ['Ubuntu-MediumItalic', 'system-ui'],
        'light-italic': ['Ubuntu-LightItalic', 'system-ui'],
        'bold-italic': ['Ubuntu-BoldItalic', 'system-ui'],
        mono: ['Ubuntu-Medium', 'monospace'],
      },
    },
  },
